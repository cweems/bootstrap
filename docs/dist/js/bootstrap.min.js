...
var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},d.offsetBottom&&(d.offset.bottom=d.offsetBottom),d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery);var scrollLocked=!1;$(document).ready(function(){function a(d){$.each(b,function(e){c.delay(1e3*d).fadeOut(),c.queue(function(){c.html(b[e]),c.dequeue()}),c.fadeIn(),c.queue(function(){e==b.length-1&&a(d),c.dequeue()})})}$(window).scroll(function(){var a=$(window).scrollTop();a>=3?($(".navbar").addClass("navbar-active"),scrollLocked=!0):($(".navbar").removeClass("navbar-active"),scrollLocked=!1)}),$(".navbar").mouseover(function(){$(".navbar").addClass("navbar-active")}).mouseleave(function(){scrollLocked===!1&&$(".navbar").delay(800).removeClass("navbar-active")});var b=["nurses","disaster responders","zookepeers","superheroes","tollboth operators","rainbow counters","economists","M&E specialists","volunteers","project managers"],c=$("#tagline-span"),d=3;a(d)});